...
const Ticket = () => {
  ...
  return (
    <Layout title="Ticket - API" activePage="ticket">
      <div>
        <h1>Ticket - API</h1>
        <p>This is the Server management page for Ticket API</p>
      </div>
    </Layout>
  );
};

...
const Forms = () => {
  ...
  return (
    <Layout title="Forms - API" activePage="forms">
      <div>
        <h1>Forms - API</h1>
        <p>This is the Server management page for Forms API</p>
      </div>
    </Layout>
  );
};
